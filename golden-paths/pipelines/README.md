...
**Purpose**: prevent merging code that was pushed _after_ Rex's last review.
...
- The OIDC IAM role itself must already exist in your AWS account, with a trust policy scoped to your repo. The pipeline _assumes_ the role; it does not create it.
